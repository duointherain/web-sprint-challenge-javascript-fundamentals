...
console.log('***request two ***');
 ...
 const lowCaseAnimalNames = zooAnimals.map(function(item){
    return `${item.animal_name.toLowerCase()}, ${item.scientific_name.toLowerCase()}`;
  });
...
populationTotal = zooAnimals.reduce(function(acc, item){
...
function greeting(fn, ln){
    console.log(`Hello ${fn} ${ln} , nice to meet you!`)
}
